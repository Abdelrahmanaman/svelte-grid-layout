...
// import { setTransform, setTopLeft, perc, resizeItemInDirection } from "../../core/position.js";
...
//   | ReactElement
//   | ((resizeHandleAxis: ResizeHandleAxis, ref: React.Ref<HTMLElement>) => ReactElement);
...
//       onDragStartRef.current?.(droppingPosition.e as unknown as MouseEvent, fakeData);
//     } else if (shouldDrag) {
//       // Continue drag
...
//       };
//       // Use ref to get latest callback without dependency
//       onDragRef.current?.(droppingPosition.e as unknown as MouseEvent, fakeData);
//     }
